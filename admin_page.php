...
if (isset($_POST['5000'])) {
  ...
  if(isset($_POST['withdraw'])){
    ...
    $allowed_minus_limit = 0;
    if($withdraw >= $allowed_minus_limit) {
    ...
    echo '<h6 style="color: red">You reach minus limit, you cant withdraw money anymore.</h6>';
  }
}
...
<h6 style="color: green">Available balance is:</h6>
