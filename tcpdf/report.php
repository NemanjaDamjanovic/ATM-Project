...
// Buffer or store the output generated by PHP scripts in memory, instead of immediately sending it to the browser.
// Prevent "TCPDF ERROR: Some data has already been output, can't send PDF file".
ob_start();
...
// Send the buffered output to the browser and turn off output buffering.
ob_end_flush();
